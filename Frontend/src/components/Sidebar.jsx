...
import "./Sidebar.css";
import { HomeIcon,CategoryIcon,ProductIcon,OrderIcon,NotificationIcon,UsersIcon,LogoutIcon ,AdminIcon, DeliveryIcon} from "./icons";
...
export default function Sidebar() {
  ...
  {(decoded?.full_name || "Admin User").toUpperCase()}
      ...
      <nav className="menu">
        ...
        >
          <UsersIcon/>
          <span style={{color:"black",fontWeight:"bold"}}>Customer</span>
        </NavLink>
         <NavLink
          to="/admin/delivery"
          className={({ isActive }) =>
        ...
        >
          <DeliveryIcon/>
          <span style={{color:"black",fontWeight:"bold"}}>Delivery Agent</span>
        </NavLink>
